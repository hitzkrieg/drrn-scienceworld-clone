...
task_index = 29
gpus_to_exclude_str = 'ials-gpu020,gpu001,gpu002,ials-gpu001,ials-gpu013,ials-gpu012,ials-gpu032,ials-gpu006'
exp_dir = 'logs_easy_limit_actions_by_pruner_hard_top_50_epsilon_fixed_navigation_100k'
exp_name = 'hard_top_50_fixed_epsilon'

sbatch_content = generate_sbatch_file(task_index=task_index, exp_dir=exp_dir, exp_name=exp_name, gpus_to_exclude_str=gpus_to_exclude_str)
